...
help([[Module which sets the PATH variable for user instaled miniforge
...
local myanapath = "software/python/miniforge3"
-- if you want to share this miniforge installation with others, use the full
-- path
--local myanapath = "/uufs/chpc.utah.edu/common/home/u6036966/software/python/miniforge3"
...
if (mode() == "load") then
  ...
  io.stdout:write("source "..myana.."/etc/profile.d/mamba."..myShellType().."\n")
end
...
whatis("Name         : Miniforge " .. version .. " Python 3")
